---
title: "Linear Modeling example using '00's market data"
...
## Brief Linear Model Project using market data from '02 - '05
...
#### All NA's and null's are left for imputation by MICE, after the removal of outliers to the median.
#### Statistically significant connections were found between E-Mini, DJIA, Shenzhen, and TSE; these connections are shown in ggplot2 graphs with geom_line.
...
### Linear Model to test connections

![Linear Model to test connections](lm_six_variables_.png)\

### Linear Models to illustrate connections

![Linear Model to illustrate connections](lm_three_variables_.png)\

![Linear Model to illustrate connections](lm_four_variables_.png)\



```{r echo=FALSE, results='hide', message=FALSE, warning=FALSE}

TSE_DJIA_intersection <- ggplot(new_lm_frame, aes(Date)) +
